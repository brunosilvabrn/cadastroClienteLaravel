    ...
    <main class="container mx-xl m-auto bg-white">
        <div class="shadow-md m-2 p-1">
            <div class="flex p-2 justify-between">
                ...
                <h3 class="mt-6 ml-2 text-3xl text-left font-bold">Pesquisar</h3>
                <div class="mt-5 ">
                <a href="{{ route('cadastrar') }}"
                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 mr-3 px-4 rounded mr-auto">Cadastrar cliente</a>
                </div>
            </div>
                ...
                <form id="formSearch">
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-1/3 px-3 mb-6 md:mb-0">
                            <label class="mascaraCpf block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2"
                                   for="grid-first-name">
                                CPF
                            </label>
                            <input
                    ...
                    <div class="md:col-span-5 text-right">
                        <div class="inline-flex items-end">
                            ...
                            <button
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mr-3 px-4 rounded">Pesquisar</button>
                            <button onclick="limparFormulario('formSearch')"
                                class="bg-slate-100 hover:bg-slate-200 text-black font-bold py-2 px-4 rounded">Limpar</button>
                        </div>
                    </div>
                </form>
            </div>
